...
?>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="carousel-caption ">
          <h2> Welcome to Medica pharmaceuticals and Health Care</h2>
          <!-- <p>Welcome to Medica pharmaceuticals and Health Care </p> -->
          <p> <a href="#" class="btn btn-warning mt-3" >Looking for goods</a> </p>
      ...
      <div class="carousel-item">
        ...
        <div class="carousel-caption ">
          <h5>Order in affordable prices</h5>
          <p> Reach to your door and give best services </p>
          <p> <a href="#" class="btn btn-warning mt-3" >Health Care</a> </p>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="carousel-caption ">
          ...
          <p> <a href="#" class="btn btn-warning mt-3">Visit to shop</a> </p>
  ...
  <section class="Product" id="pharma">
   ...
   <div class="row">
     ...
     <p  > <a href="product.php" class="btn btn-warning mt-3"> Click here more </a> </p>
     </div>
   </div>
    </div>
  </section>
  ...
  <div class="container py-5">
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        ...
        <h5 class="mt-3"  >Healthy Salad</h5>
    ...
    <p  > <a href="#" class="btn btn-warning mt-3"> Click here more read </a> </p>
  </div>
</div>
</section>

<section class="explore" id="items">
  <div class="container py-5">
    <div class="row py-5">
      <div class="col-lg-3 m-auto mb-5">
    ...
    <div class="row">
      <div class="col-lg-3">
        ...
        <h6 >Neptor Cap 20</h6>
        <p  > <a href="#" class="btn btn-warning mt-3"> $ 59.99 </a> </p>
      </div>
      ...
      <div class="col-lg-3">
        ...
        <h6  >Gripe Water</h6>
        <p  > <a href="#" class="btn btn-warning mt-3" > $ 19.99 </a> </p>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <h6  >Telcardis 40</h6>
        <p > <a href="#" class="btn btn-warning mt-3"> $ 2.99 </a> </p>
      </div>
      ...
      <div class="col-lg-3">
        ...
        <p  > <a href="#" class="btn btn-warning mt-3"> $ 4.99 </a> </p>
      </div>
      ...
      <div class="col-lg-3">
        ...
        <h6 >Veet Body Waxing kit</h6>
        <p  > <a href="#" class="btn btn-warning mt-3"> $ 5.99 </a> </p>
      </div>
      ...
      <div class="col-lg-3">
        ...
        <h6  >Joya Napkin</h6>
        <p  > <a href="#" class="btn btn-warning mt-3"> $ 1.99 </a> </p>
      </div>
